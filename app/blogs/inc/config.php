...
define('DC_MASTER_KEY','839df2af9d25eb5dede7886e5720c095');


// Admin URL. You need to set it for some features.
define('DC_ADMIN_URL','http://localhost/imestre/app/blogs/admin/');

// Admin mail from address. For password recovery and such.
define('DC_ADMIN_MAILFROM','dotclear@localhost');
