<?php
	echo '<ul class="button-group radius" style="background-color: #008CBA">
			...
			<button href="#" data-dropdown="questoes" aria-controls="questoes" aria-expanded="false" class="button dropdown">Avaliação</button>
			<ul id="questoes" data-dropdown-content class="f-dropdown" aria-hidden="true" tabindex="-1">
				<li><a href="cadAvaliacao.php" id="cadAvaliacao">Cadastro de Avaliações</a></li>
				<li><a href="listaAvaliacoes.php" id="listaAvaliacoes">Listagem de Avaliações</a></li>
				<li><a href="cadQuestao.php" id="cadQuestao">Cadastro de Questões</a></li>
